...
fn main() {
    ...
    let mut inner_radius: f32 = 80.0;
    let mut outer_radius: f32 = 190.0;

    let mut start_angle: f32 = 0.0;
    let mut end_angle: f32 = 360.0;
    ...
    // Detect window close button or ESC key
    {
        ...
        d.gui_check_box(
            ...
            "Draw CircleLines",
            &mut draw_circle_lines,
        );
        //------------------------------------------------------------------------------

        let min_segments = ((end_angle - start_angle) / 90.0).ceil() as i32;
        let manual = segments as i32 >= min_segments;
        d.draw_text(
